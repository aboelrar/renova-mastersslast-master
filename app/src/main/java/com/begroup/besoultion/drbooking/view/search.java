...
import com.begroup.besoultion.drbooking.adapter.tasneefAdapter;
...
import com.begroup.besoultion.drbooking.presenter.doctorPresenter;
...
RecyclerView.LayoutManager layoutManager;
    ...
    public static final String searchUrl="http://drbookingsa.com/renova_en/Search/index/54732964/259743/";
    TextView tasneef;
    ViewSwitcher viewSwitcher;
    com.begroup.besoultion.drbooking.library.checkConnection checkConnection;
    @Override
   ...
   public void getAllData(String filter)
   {
       ...
       if(get.equals("0"))
       {
           ...
           searchurl="http://drbookingsa.com/renova_en/Doctor/getAll/54732964/259743/"+savedId.getId(search.this);
