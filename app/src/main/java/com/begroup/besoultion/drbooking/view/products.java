...
import com.begroup.besoultion.drbooking.adapter.productAdapter;
import com.begroup.besoultion.drbooking.interfacee.MVP;
import com.begroup.besoultion.drbooking.presenter.productPresrenter;
...
public class products extends AppCompatActivity implements MVP.interfaces.View {
    ...
    public static final String productUrl="http://drbookingsa.com/renova_en/product/getAll/54732964/259743";
    ImageView back;
    @Override
...
public void appBar()
{
  ...
  back.setOnClickListener(new View.OnClickListener() {
    ...
    public void getProductData()
    {
       ...
       final ArrayList<com.begroup.besoultion.drbooking.list.productList>productList=new ArrayList<productList>();
        JsonObjectRequest request=new JsonObjectRequest(Request.Method.GET, productUrl, null, new Response.Listener<JSONObject>() {
            ...
            public void onResponse(JSONObject response) {
                try {
                    ...
                    Log.e("products",e.getLocalizedMessage());
