...
public class productDetails extends AppCompatActivity {
    ...
    public static final String productUrl="http://coderg.org/renova_en/product/view/54732964/259743/";
    public static final String makeOrder="http://coderg.org/renova_en/product/buyProduct/54732964/259743/";
Boolean IsFav=false;
    @Override
    ...
    public void getProductDetails()
    {
     ...
     public void progressDialog()
     {
         ...
         close.setOnClickListener(new View.OnClickListener() {
             ...
             public void onClick(View v) {
                 makeOrder();
                 progressdialog.progressDialog(com.example.lenovo.renova.view.productDetails.this);
             startActivity(new Intent(productDetails.this,successfulpayment.class));
             }
         });
     }
