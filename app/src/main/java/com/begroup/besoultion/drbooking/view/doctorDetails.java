...
import com.begroup.besoultion.drbooking.adapter.reservationAdapter;
import com.begroup.besoultion.drbooking.interfacee.MVP;
import com.begroup.besoultion.drbooking.library.savedId;
import com.begroup.besoultion.drbooking.presenter.reservationPresenter;
...
RecyclerView reservationList;
    ...
    ImageView rating;
    Boolean isfav=false;
    public static final String DoctorDetails="http://drbookingsa.com/renova_en/Doctor/view/54732964/259743/";
    ...
    public static final String setRate="http://drbookingsa.com/renova_en/User/addRate/54732964/259743/";
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        descripition=(TextView)findViewById(R.id.descripition);
         ...
         ratingBar=(RatingBar)findViewById(R.id.ratings);
            rating=(ImageView) findViewById(R.id.star);
         onClick();
         getDoctorDetails();
         bottomNav();
         isFav();}
    ...
    public void getDoctorDetails()
    {
        ...
        reservationList=(RecyclerView)findViewById(R.id.reservationList);
        savedId=new savedId();
        Log.e("doctorsDetails",DoctorDetails+id+"/"+savedId.getId(doctorDetails.this));
        ...
        JsonObjectRequest request=new JsonObjectRequest(Request.Method.GET, DoctorDetails+id+"/"+savedId.getId(doctorDetails.this), null, new Response.Listener<JSONObject>() {
            ...
            public void onResponse(JSONObject response) {
                try {
                    ...
                    Log.e("docdetails",e.getLocalizedMessage());
                }
            }
        ...
        StringRequest addFav=new StringRequest(Request.Method.GET, Url+savedId.getId(doctorDetails.this)+"/"+id, new Response.Listener<String>() {
            ...
            public void onResponse(String response) {
                try {
                    ...
                    Log.e("add",e.getLocalizedMessage());
    ...
    {
        savedId savedId=new savedId();
        Log.e("rate",setRate + savedId.getId(doctorDetails.this) + "/" + id + "/" + rate);
