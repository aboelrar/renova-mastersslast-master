...
public class myfavourites extends AppCompatActivity {
    ...
    TextView title;
    ImageView back;
    public static final String favUrl="http://drbookingsa.com/renova_en/User/getFavoriteDoctors/54732964/259743/";
    ...
    public void getAllData()
    {
        ...
        Log.e("myFav",favUrl+savedId.getId(myfavourites.this));
